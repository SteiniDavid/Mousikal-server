let app,debug0,http,fs,path;_cdd‍.w("../app",[["default",["app"],function(v){app=v}]]);_cdd‍.w("debug",[["default",["debug0"],function(v){debug0=v}]]);_cdd‍.w("http",[["default",["http"],function(v){http=v}]]);_cdd‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_cdd‍.w("path",[["default",["path"],function(v){path=v}]]);
...
function onError(error) {
  ...
  switch (error.code) {
    case 'EACCES':
      _cdd‍.g.console.error(bind + ' requires elevated privileges');
      process.exit(1);
      break;
    case 'EADDRINUSE':
      _cdd‍.g.console.error(bind + ' is already in use');
      process.exit(1);
      break;
    default:
      throw error;
