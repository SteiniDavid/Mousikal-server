let Store,path,fs,debug;_bb6‍.w("data-store",[["default",["Store"],function(v){Store=v}]]);_bb6‍.w("path",[["default",["path"],function(v){path=v}]]);_bb6‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_bb6‍.w("debug",[["default",["debug"],function(v){debug=v}]]);
