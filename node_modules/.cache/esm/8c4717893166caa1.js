let app,debug0,http,fs,path;_316‍.w("../app",[["default",["app"],function(v){app=v}]]);_316‍.w("debug",[["default",["debug0"],function(v){debug0=v}]]);_316‍.w("http",[["default",["http"],function(v){http=v}]]);_316‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_316‍.w("path",[["default",["path"],function(v){path=v}]]);
...
function onError(error) {
  ...
  switch (error.code) {
    case 'EACCES':
      _316‍.g.console.error(bind + ' requires elevated privileges');
      process.exit(1);
      break;
    case 'EADDRINUSE':
      _316‍.g.console.error(bind + ' is already in use');
      process.exit(1);
      break;
    default:
      throw error;
